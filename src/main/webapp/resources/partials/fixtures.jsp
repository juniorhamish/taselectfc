            ...
            <div class="col-lg-12">
                ...
                <div ng-repeat="fixture in fixtures">
                    <div class="fixture-summary">
                        <div class="flag-left"><img ng-src="/resources/images/flags/medium/{{fixture.homeTeamFlag}}" /></div>
                        <div class="details">
                        ...
                        <div class="flag-right"><img ng-src="/resources/images/flags/medium/{{fixture.awayTeamFlag}}" /></div>
                    </div>
                    <hr>
                </div>
            </div>
